...
/* global ig, EntityItem, EntityFireball, EntityMaster, EntityBasicSwing, BasicStructure, EntityBlob, EntitySelector, HUD */
ig.module(
	...
	EntityMaster = ig.Entity.extend({
		...
		update: function() {
			...
			if(ig.input.pressed('build_structure')) {
				ig.game.spawnEntity(BasicStructure, this.pos.x+60, this.pos.y, {ownedBy:this});
			}
